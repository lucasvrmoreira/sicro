...
export default function Entrada() {
  ...
  // Ref para focar no input de quantidade após selecionar tamanho
  const qtdInputRef = useRef(null);

  const tamanhosDisponiveis = ["PP", "P", "M", "G", "GG", "G3", "G4"];
  
  // Configuração visual dos tipos (Ícones e Cores)
  ...
  const adicionarItem = () => {
    ...
    // Verifica tamanho se necessário
    ...
    // Foca de volta no início ou mantém fluxo? Aqui reseta.
  };
  ...
  const handleEntrada = async () => {
    ...
    try {
      ...
      console.error(err);
      toast.error("Erro ao registrar. Verifique sua conexão ou permissões.");
    }
  };
    ...
    <div className="max-w-6xl mx-auto mt-8 px-4 grid grid-cols-1 lg:grid-cols-12 gap-8 animate-fadeIn">
      ...
      <div className="lg:col-span-7 space-y-6">
        ...
        <div className="bg-gray-900/60 backdrop-blur-xl border border-gray-800 p-6 rounded-2xl shadow-xl">
          ...
          {/* 1. SELEÇÃO DE TIPO (CHIPS VISUAIS) */}
          ...
          {/* 2. SELEÇÃO DE TAMANHO (CONDICIONAL) */}
                ...
                {tamanhosDisponiveis.map((tam) => (
                  <button
                    ...
                    onClick={() => {
                        ...
                        qtdInputRef.current?.focus(); // Pula pro input de qtd automaticamente
                    }}
                    className={`
          ...
          <div className="flex flex-col md:flex-row gap-4 items-end">
            <div className="w-full md:w-1/2">
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-950 border border-gray-700 text-white text-lg rounded-xl px-4 py-3 focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all placeholder-gray-600"
                  placeholder="0"
                />
            ...
            <button
              ...
              className="w-full md:w-1/2 bg-green-600 hover:bg-green-500 text-white font-bold py-3.5 px-6 rounded-xl transition-all shadow-lg shadow-green-900/20 active:scale-95 flex items-center justify-center gap-2"
            >
      ...
      <div className="lg:col-span-5">
        <div className="bg-gray-900/60 backdrop-blur-xl border border-gray-800 p-6 rounded-2xl shadow-xl h-full flex flex-col">
          <div className="flex justify-between items-center mb-6 border-b border-gray-800 pb-4">
            <h2 className="text-xl font-bold text-white">Itens na Caixa</h2>
              ...
              {movimentacoes.map((m, i) => (
                <div key={i} className="group flex justify-between items-center bg-gray-800/50 hover:bg-gray-800 border border-gray-700/50 p-3 rounded-xl transition-all">
                  ...
                  <div className="flex items-center gap-4">
                    <span className="font-mono text-green-400 font-bold bg-green-400/10 px-2 py-1 rounded text-sm">
                      +{m.quantidade}
                    </span>
                    <button 
          ...
          <div className="mt-6 pt-4 border-t border-gray-800">
             <button
               ...
               className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-500 hover:to-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-bold py-4 rounded-xl shadow-lg transition-all transform active:scale-[0.98] flex justify-center items-center gap-2"
             >
